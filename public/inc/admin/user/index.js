function IndexMgr(instance) {
    if (!instance) instance = "index";
    this.instance = instance;
    this.route = this.route + '/' + instance;
}

IndexMgr.prototype = new UserMgr();

IndexMgr.prototype.afterInitialize = function () {
    var piThis = this;
    $btnDel = $("a[btndel]");
    $btnDel.unbind("click");
...
IndexMgr.prototype.submitModalDel = function () {
    var piThis = this;
