...
_52b.append("<a href=\"javascript:void(0)\" class=\"spinner-arrow-up\" tabindex=\"-1\"></a>");
_52b.append("<a href=\"javascript:void(0)\" class=\"spinner-arrow-down\" tabindex=\"-1\"></a>");
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable:false}]],showGroup:false,groupView:_7b0,groupField:"group",groupFormatter:function(_7ed,rows){
return _7ed;
}});
})(jQuery);
(function($){
...
var _901=_900.combo;
if(!$.isArray(_8ff)){
_8ff=_8ff.split(opts.separator);
}
var _902=_8f9(_8fe);
...
if(!$.isArray(_92f)){
_92f=_92f.split(opts.separator);
}
...
},onCheck:function(node,_96b){
_96c(_966);
opts.onCheck.call(this,node,_96b);
}}));
};
function _96c(_96d){
var _96e=$.data(_96d,"combotree");
...
$(_96d).combo("setValues",vv).combo("setText",ss.join(opts.separator));
};
function _970(_971,_972){
var _973=$.data(_971,"combotree");
var opts=_973.options;
var tree=_973.tree;
var _974=tree.tree("options");
var _975=_974.onCheck;
var _976=_974.onSelect;
_974.onCheck=_974.onSelect=function(){
};
tree.find("span.tree-checkbox").addClass("tree-checkbox0").removeClass("tree-checkbox1 tree-checkbox2");
if(!$.isArray(_972)){
_972=_972.split(opts.separator);
}
for(var i=0;i<_972.length;i++){
var node=tree.tree("find",_972[i]);
if(node){
...
$.fn.combotree=function(_977,_978){
if(typeof _977=="string"){
var _979=$.fn.combotree.methods[_977];
if(_979){
return _979(this,_978);
}else{
return this.combo(_977,_978);
}
}
_977=_977||{};
return this.each(function(){
var _97a=$.data(this,"combotree");
if(_97a){
$.extend(_97a.options,_977);
}else{
$.data(this,"combotree",{options:$.extend({},$.fn.combotree.defaults,$.fn.combotree.parseOptions(this),_977)});
}
_965(this);
});
};
$.fn.combotree.methods={options:function(jq){
var _97b=jq.combo("options");
return $.extend($.data(jq[0],"combotree").options,{width:_97b.width,height:_97b.height,originalValue:_97b.originalValue,disabled:_97b.disabled,readonly:_97b.readonly});
},clone:function(jq,_97c){
var t=jq.combo("clone",_97c);
...
},setValues:function(jq,_97d){
return jq.each(function(){
_970(this,_97d);
});
},setValue:function(jq,_97e){
return jq.each(function(){
_970(this,[_97e]);
});
},clear:function(jq){
...
$.fn.combotree.parseOptions=function(_97f){
return $.extend({},$.fn.combo.parseOptions(_97f),$.fn.tree.parseOptions(_97f));
};
$.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.tree.defaults,{editable:false});
})(jQuery);
(function($){
function _980(_981){
var _982=$.data(_981,"combogrid");
var opts=_982.options;
var grid=_982.grid;
$(_981).addClass("combogrid-f").combo($.extend({},opts,{onShowPanel:function(){
var p=$(this).combogrid("panel");
var _983=p.outerHeight()-p.height();
var _984=p._size("minHeight");
var _985=p._size("maxHeight");
$(this).combogrid("grid").datagrid("resize",{width:"100%",height:(isNaN(parseInt(opts.panelHeight))?"auto":"100%"),minHeight:(_984?_984-_983:""),maxHeight:(_985?_985-_983:"")});
opts.onShowPanel.call(this);
}}));
var _986=$(_981).combo("panel");
if(!grid){
grid=$("<table></table>").appendTo(_986);
_982.grid=grid;
}
grid.datagrid($.extend({},opts,{border:false,singleSelect:(!opts.multiple),onLoadSuccess:function(data){
var _987=$(_981).combo("getValues");
var _988=opts.onSelect;
opts.onSelect=function(){
};
_992(_981,_987,_982.remainText);
opts.onSelect=_988;
opts.onLoadSuccess.apply(_981,arguments);
},onClickRow:_989,onSelect:function(_98a,row){
_98b();
opts.onSelect.call(this,_98a,row);
},onUnselect:function(_98c,row){
_98b();
opts.onUnselect.call(this,_98c,row);
},onSelectAll:function(rows){
_98b();
...
function _989(_98d,row){
_982.remainText=false;
_98b();
if(!opts.multiple){
$(_981).combo("hidePanel");
}
opts.onClickRow.call(this,_98d,row);
};
function _98b(){
...
if(!opts.multiple){
$(_981).combo("setValues",(vv.length?vv:[""]));
}else{
$(_981).combo("setValues",vv);
}
if(!_982.remainText){
$(_981).combo("setText",ss.join(opts.separator));
}
};
};
function nav(_98e,dir){
var _98f=$.data(_98e,"combogrid");
var opts=_98f.options;
var grid=_98f.grid;
var _990=grid.datagrid("getRows").length;
if(!_990){
return;
}
...
var _991;
if(!tr.length){
_991=(dir=="next"?0:_990-1);
}else{
var _991=parseInt(tr.attr("datagrid-row-index"));
_991+=(dir=="next"?1:-1);
if(_991<0){
_991=_990-1;
}
...
grid.datagrid("highlightRow",_991);
if(opts.selectOnNavigation){
_98f.remainText=false;
grid.datagrid("selectRow",_991);
}
};
function _992(_993,_994,_995){
var _996=$.data(_993,"combogrid");
var opts=_996.options;
var grid=_996.grid;
var rows=grid.datagrid("getRows");
var ss=[];
var _997=$(_993).combo("getValues");
var _998=$(_993).combo("options");
var _999=_998.onChange;
_998.onChange=function(){
};
grid.datagrid("clearSelections");
if(!$.isArray(_994)){
_994=_994.split(opts.separator);
}
for(var i=0;i<_994.length;i++){
var _99a=grid.datagrid("getRowIndex",_994[i]);
if(_99a>=0){
grid.datagrid("selectRow",_99a);
ss.push(rows[_99a][opts.textField]);
}else{
ss.push(_994[i]);
}
}
$(_993).combo("setValues",_997);
_998.onChange=_999;
$(_993).combo("setValues",_994);
if(!_995){
var s=ss.join(opts.separator);
if($(_993).combo("getText")!=s){
$(_993).combo("setText",s);
}
}
};
function _99b(_99c,q){
var _99d=$.data(_99c,"combogrid");
var opts=_99d.options;
var grid=_99d.grid;
_99d.remainText=true;
if(opts.multiple&&!q){
_992(_99c,[],true);
}else{
_992(_99c,[q],true);
...
if(opts.filter.call(_99c,q,row)){
...
function _99e(_99f){
var _9a0=$.data(_99f,"combogrid");
var opts=_9a0.options;
var grid=_9a0.grid;
var tr=opts.finder.getTr(grid[0],null,"highlight");
_9a0.remainText=false;
if(tr.length){
var _9a1=parseInt(tr.attr("datagrid-row-index"));
if(opts.multiple){
if(tr.hasClass("datagrid-row-selected")){
grid.datagrid("unselectRow",_9a1);
}else{
grid.datagrid("selectRow",_9a1);
}
}else{
grid.datagrid("selectRow",_9a1);
}
...
$(_99f).combogrid("setValues",vv);
if(!opts.multiple){
$(_99f).combogrid("hidePanel");
}
};
$.fn.combogrid=function(_9a2,_9a3){
if(typeof _9a2=="string"){
var _9a4=$.fn.combogrid.methods[_9a2];
if(_9a4){
return _9a4(this,_9a3);
}else{
return this.combo(_9a2,_9a3);
}
}
_9a2=_9a2||{};
return this.each(function(){
var _9a5=$.data(this,"combogrid");
if(_9a5){
$.extend(_9a5.options,_9a2);
}else{
_9a5=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_9a2)});
}
_980(this);
});
};
$.fn.combogrid.methods={options:function(jq){
var _9a6=jq.combo("options");
return $.extend($.data(jq[0],"combogrid").options,{width:_9a6.width,height:_9a6.height,originalValue:_9a6.originalValue,disabled:_9a6.disabled,readonly:_9a6.readonly});
},grid:function(jq){
return $.data(jq[0],"combogrid").grid;
},setValues:function(jq,_9a7){
return jq.each(function(){
_992(this,_9a7);
});
},setValue:function(jq,_9a8){
return jq.each(function(){
_992(this,[_9a8]);
});
},clear:function(jq){
...
$.fn.combogrid.parseOptions=function(_9a9){
var t=$(_9a9);
return $.extend({},$.fn.combo.parseOptions(_9a9),$.fn.datagrid.parseOptions(_9a9),$.parser.parseOptions(_9a9,["idField","textField","mode"]));
};
...
(function($){
function _9aa(_9ab){
var _9ac=$.data(_9ab,"datebox");
var opts=_9ac.options;
$(_9ab).addClass("datebox-f").combo($.extend({},opts,{onShowPanel:function(){
_9ad(this);
_9ae(this);
_9af(this);
_9bd(this,$(this).datebox("getText"),true);
opts.onShowPanel.call(this);
}}));
if(!_9ac.calendar){
var _9b0=$(_9ab).combo("panel").css("overflow","hidden");
_9b0.panel("options").onBeforeDestroy=function(){
var c=$(this).find(".calendar-shared");
if(c.length){
c.insertBefore(c[0].pholder);
}
};
var cc=$("<div class=\"datebox-calendar-inner\"></div>").prependTo(_9b0);
...
_9ac.calendar=$("<div></div>").appendTo(cc).calendar();
}
$.extend(_9ac.calendar.calendar("options"),{fit:true,border:false,onSelect:function(date){
var _9b1=this.target;
var opts=$(_9b1).datebox("options");
_9bd(_9b1,opts.formatter.call(_9b1,date));
$(_9b1).combo("hidePanel");
opts.onSelect.call(_9b1,date);
}});
}
$(_9ab).combo("textbox").parent().addClass("datebox");
$(_9ab).datebox("initValue",opts.value);
function _9ad(_9b2){
var opts=$(_9b2).datebox("options");
var _9b3=$(_9b2).combo("panel");
_9b3.unbind(".datebox").bind("click.datebox",function(e){
if($(e.target).hasClass("datebox-button-a")){
var _9b4=parseInt($(e.target).attr("datebox-button-index"));
opts.buttons[_9b4].handler.call(e.target,_9b2);
}
});
};
function _9ae(_9b5){
var _9b6=$(_9b5).combo("panel");
if(_9b6.children("div.datebox-button").length){
return;
}
var _9b7=$("<div class=\"datebox-button\"><table cellspacing=\"0\" cellpadding=\"0\" style=\"width:100%\"><tr></tr></table></div>").appendTo(_9b6);
var tr=_9b7.find("tr");
for(var i=0;i<opts.buttons.length;i++){
var td=$("<td></td>").appendTo(tr);
var btn=opts.buttons[i];
var t=$("<a class=\"datebox-button-a\" href=\"javascript:void(0)\"></a>").html($.isFunction(btn.text)?btn.text(_9b5):btn.text).appendTo(td);
t.attr("datebox-button-index",i);
}
tr.find("td").css("width",(100/opts.buttons.length)+"%");
};
function _9af(_9b8){
var _9b9=$(_9b8).combo("panel");
var cc=_9b9.children("div.datebox-calendar-inner");
_9b9.children()._outerWidth(_9b9.width());
_9ac.calendar.appendTo(cc);
_9ac.calendar[0].target=_9b8;
if(opts.panelHeight!="auto"){
var _9ba=_9b9.height();
_9b9.children().not(cc).each(function(){
_9ba-=$(this).outerHeight();
});
cc._outerHeight(_9ba);
}
_9ac.calendar.calendar("resize");
};
};
function _9bb(_9bc,q){
_9bd(_9bc,q,true);
};
function _9be(_9bf){
...
$.fn.datebox=function(_9c7,_9c8){
if(typeof _9c7=="string"){
var _9c9=$.fn.datebox.methods[_9c7];
if(_9c9){
return _9c9(this,_9c8);
}else{
return this.combo(_9c7,_9c8);
}
}
_9c7=_9c7||{};
return this.each(function(){
var _9ca=$.data(this,"datebox");
if(_9ca){
$.extend(_9ca.options,_9c7);
}else{
$.data(this,"datebox",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_9c7)});
}
_9aa(this);
});
};
$.fn.datebox.methods={options:function(jq){
var _9cb=jq.combo("options");
return $.extend($.data(jq[0],"datebox").options,{width:_9cb.width,height:_9cb.height,originalValue:_9cb.originalValue,disabled:_9cb.disabled,readonly:_9cb.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_9cc){
return jq.each(function(){
var opts=$(this).datebox("options");
var _9cd=opts.value;
if(_9cd){
_9cd=opts.formatter.call(this,opts.parser.call(this,_9cd));
}
$(this).combo("initValue",_9cd).combo("setText",_9cd);
});
...
$.fn.datebox.parseOptions=function(_9cf){
return $.extend({},$.fn.combo.parseOptions(_9cf),$.parser.parseOptions(_9cf,["sharedCalendar"]));
};
...
_9bb(this,q);
}},currentText:"Today",closeText:"Close",okText:"Ok",buttons:[{text:function(_9d0){
return $(_9d0).datebox("options").currentText;
},handler:function(_9d1){
$(_9d1).datebox("calendar").calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:new Date()});
_9be(_9d1);
}},{text:function(_9d2){
return $(_9d2).datebox("options").closeText;
},handler:function(_9d3){
...
(function($){
function _9d4(_9d5){
var _9d6=$.data(_9d5,"datetimebox");
var opts=_9d6.options;
$(_9d5).datebox($.extend({},opts,{onShowPanel:function(){
var _9d7=$(this).datetimebox("getValue");
_9dd(this,_9d7,true);
opts.onShowPanel.call(this);
},formatter:$.fn.datebox.defaults.formatter,parser:$.fn.datebox.defaults.parser}));
$(_9d5).removeClass("datebox-f").addClass("datetimebox-f");
$(_9d5).datebox("calendar").calendar({onSelect:function(date){
opts.onSelect.call(this.target,date);
}});
if(!_9d6.spinner){
var _9d8=$(_9d5).datebox("panel");
var p=$("<div style=\"padding:2px\"><input></div>").insertAfter(_9d8.children("div.datebox-calendar-inner"));
_9d6.spinner=p.children("input");
}
_9d6.spinner.timespinner({width:opts.spinnerWidth,showSeconds:opts.showSeconds,separator:opts.timeSeparator});
$(_9d5).datetimebox("initValue",opts.value);
};
function _9d9(_9da){
...
var date=opts.parser.call(_9e0,_9e1);
$(_9e0).datetimebox("calendar").calendar("moveTo",date);
$(_9e0).datetimebox("spinner").timespinner("setValue",_9e3(date));
function _9e3(date){
function _9e4(_9e5){
return (_9e5<10?"0":"")+_9e5;
};
var tt=[_9e4(date.getHours()),_9e4(date.getMinutes())];
if(opts.showSeconds){
tt.push(_9e4(date.getSeconds()));
}
return tt.join($(_9e0).datetimebox("spinner").timespinner("options").separator);
};
};
$.fn.datetimebox=function(_9e6,_9e7){
if(typeof _9e6=="string"){
var _9e8=$.fn.datetimebox.methods[_9e6];
if(_9e8){
return _9e8(this,_9e7);
}else{
return this.datebox(_9e6,_9e7);
}
}
_9e6=_9e6||{};
return this.each(function(){
var _9e9=$.data(this,"datetimebox");
if(_9e9){
$.extend(_9e9.options,_9e6);
}else{
$.data(this,"datetimebox",{options:$.extend({},$.fn.datetimebox.defaults,$.fn.datetimebox.parseOptions(this),_9e6)});
}
_9d4(this);
});
};
$.fn.datetimebox.methods={options:function(jq){
var _9ea=jq.datebox("options");
return $.extend($.data(jq[0],"datetimebox").options,{originalValue:_9ea.originalValue,disabled:_9ea.disabled,readonly:_9ea.readonly});
},cloneFrom:function(jq,from){
return jq.each(function(){
...
},initValue:function(jq,_9eb){
return jq.each(function(){
var opts=$(this).datetimebox("options");
var _9ec=opts.value;
if(_9ec){
_9ec=opts.formatter.call(this,opts.parser.call(this,_9ec));
}
$(this).combo("initValue",_9ec).combo("setText",_9ec);
});
},setValue:function(jq,_9ed){
return jq.each(function(){
_9dd(this,_9ed);
});
},reset:function(jq){
...
$.fn.datetimebox.parseOptions=function(_9ee){
var t=$(_9ee);
return $.extend({},$.fn.datebox.parseOptions(_9ee),$.parser.parseOptions(_9ee,["timeSeparator","spinnerWidth",{showSeconds:"boolean"}]));
};
...
_9db(this,q);
}},buttons:[{text:function(_9ef){
return $(_9ef).datetimebox("options").currentText;
},handler:function(_9f0){
var opts=$(_9f0).datetimebox("options");
_9dd(_9f0,opts.formatter.call(_9f0,new Date()));
$(_9f0).datetimebox("hidePanel");
}},{text:function(_9f1){
return $(_9f1).datetimebox("options").okText;
},handler:function(_9f2){
_9de(_9f2);
}},{text:function(_9f3){
return $(_9f3).datetimebox("options").closeText;
...
function _9f5(_9f6){
return (_9f6<10?"0":"")+_9f6;
};
var _9f7=$(this).datetimebox("spinner").timespinner("options").separator;
var r=$.fn.datebox.defaults.formatter(date)+" "+_9f5(h)+_9f7+_9f5(M);
...
var _9f8=$(this).datetimebox("spinner").timespinner("options").separator;
var tt=dt[1].split(_9f8);
var hour=parseInt(tt[0],10)||0;
var _9f9=parseInt(tt[1],10)||0;
var _9fa=parseInt(tt[2],10)||0;
return new Date(d.getFullYear(),d.getMonth(),d.getDate(),hour,_9f9,_9fa);
}});
})(jQuery);
(function($){
function init(_9fb){
var _9fc=$("<div class=\"slider\">"+"<div class=\"slider-inner\">"+"<a href=\"javascript:void(0)\" class=\"slider-handle\"></a>"+"<span class=\"slider-tip\"></span>"+"</div>"+"<div class=\"slider-rule\"></div>"+"<div class=\"slider-rulelabel\"></div>"+"<div style=\"clear:both\"></div>"+"<input type=\"hidden\" class=\"slider-value\">"+"</div>").insertAfter(_9fb);
var t=$(_9fb);
t.addClass("slider-f").hide();
var name=t.attr("name");
if(name){
_9fc.find("input.slider-value").attr("name",name);
t.removeAttr("name").attr("sliderName",name);
}
_9fc.bind("_resize",function(e,_9fd){
if($(this).hasClass("easyui-fluid")||_9fd){
_9fe(_9fb);
}
return false;
});
...
var _a01=$.data(_9ff,"slider");
var opts=_a01.options;
var _a02=_a01.slider;
if(_a00){
if(_a00.width){
opts.width=_a00.width;
}
if(_a00.height){
opts.height=_a00.height;
}
}
_a02._size(opts);
if(opts.mode=="h"){
_a02.css("height","");
_a02.children("div").css("height","");
}else{
_a02.css("width","");
_a02.children("div").css("width","");
_a02.children("div.slider-rule,div.slider-rulelabel,div.slider-inner")._outerHeight(_a02._outerHeight());
}
_a03(_9ff);
};
function _a04(_a05){
var _a06=$.data(_a05,"slider");
...
_a08(aa);
function _a08(aa){
var rule=_a07.find("div.slider-rule");
var _a09=_a07.find("div.slider-rulelabel");
rule.empty();
_a09.empty();
for(var i=0;i<aa.length;i++){
var _a0a=i*100/(aa.length-1)+"%";
var span=$("<span></span>").appendTo(rule);
span.css((opts.mode=="h"?"left":"top"),_a0a);
if(aa[i]!="|"){
span=$("<span></span>").appendTo(_a09);
span.html(aa[i]);
if(opts.mode=="h"){
span.css({left:_a0a,marginLeft:-Math.round(span.outerWidth()/2)});
}else{
span.css({top:_a0a,marginTop:-Math.round(span.outerHeight()/2)});
}
}
}
};
...
function _a0b(_a0c){
var _a0d=$.data(_a0c,"slider");
var opts=_a0d.options;
var _a0e=_a0d.slider;
_a0e.removeClass("slider-h slider-v slider-disabled");
_a0e.addClass(opts.mode=="h"?"slider-h":"slider-v");
_a0e.addClass(opts.disabled?"slider-disabled":"");
_a0e.find("a.slider-handle").draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
...
var _a10=_a22(_a0c,left);
_a11(_a10);
return false;
}
},onBeforeDrag:function(){
_a0d.isDragging=true;
},onStartDrag:function(){
opts.onSlideStart.call(_a0c,opts.value);
},onStopDrag:function(e){
var _a12=_a22(_a0c,(opts.mode=="h"?e.data.left:e.data.top));
_a11(_a12);
opts.onSlideEnd.call(_a0c,opts.value);
opts.onComplete.call(_a0c,opts.value);
_a0d.isDragging=false;
}});
_a0e.find("div.slider-inner").unbind(".slider").bind("mousedown.slider",function(e){
if(_a0d.isDragging||opts.disabled){
return;
}
var pos=$(this).offset();
var _a13=_a22(_a0c,(opts.mode=="h"?(e.pageX-pos.left):(e.pageY-pos.top)));
_a11(_a13);
opts.onComplete.call(_a0c,opts.value);
});
function _a11(_a14){
var s=Math.abs(_a14%opts.step);
if(s<opts.step/2){
_a14-=s;
}else{
_a14=_a14-s+opts.step;
}
_a15(_a0c,_a14);
};
};
function _a15(_a16,_a17){
var _a18=$.data(_a16,"slider");
...
opts.value=_a17;
$(_a16).val(_a17);
_a19.find("input.slider-value").val(_a17);
var pos=_a1b(_a16,_a17);
var tip=_a19.find(".slider-tip");
if(opts.showTip){
tip.show();
tip.html(opts.tipFormatter.call(_a16,opts.value));
}else{
tip.hide();
}
if(opts.mode=="h"){
var _a1c="left:"+pos+"px;";
_a19.find(".slider-handle").attr("style",_a1c);
tip.attr("style",_a1c+"margin-left:"+(-Math.round(tip.outerWidth()/2))+"px");
}else{
var _a1c="top:"+pos+"px;";
_a19.find(".slider-handle").attr("style",_a1c);
tip.attr("style",_a1c+"margin-left:"+(-Math.round(tip.outerWidth()))+"px");
}
if(_a1a!=_a17){
opts.onChange.call(_a16,_a17,_a1a);
}
};
function _a03(_a1d){
var opts=$.data(_a1d,"slider").options;
var fn=opts.onChange;
opts.onChange=function(){
};
_a15(_a1d,opts.value);
opts.onChange=fn;
};
function _a1b(_a1e,_a1f){
var _a20=$.data(_a1e,"slider");
var opts=_a20.options;
var _a21=_a20.slider;
var size=opts.mode=="h"?_a21.width():_a21.height();
var pos=opts.converter.toPosition.call(_a1e,_a1f,size);
if(opts.mode=="v"){
pos=_a21.height()-pos;
}
if(opts.reversed){
...
function _a22(_a23,pos){
var _a24=$.data(_a23,"slider");
var opts=_a24.options;
var _a25=_a24.slider;
var size=opts.mode=="h"?_a25.width():_a25.height();
var _a26=opts.converter.toValue.call(_a23,opts.mode=="h"?(opts.reversed?(size-pos):pos):(size-pos),size);
return _a26.toFixed(0);
};
$.fn.slider=function(_a27,_a28){
if(typeof _a27=="string"){
return $.fn.slider.methods[_a27](this,_a28);
}
_a27=_a27||{};
return this.each(function(){
var _a29=$.data(this,"slider");
if(_a29){
$.extend(_a29.options,_a27);
}else{
_a29=$.data(this,"slider",{options:$.extend({},$.fn.slider.defaults,$.fn.slider.parseOptions(this),_a27),slider:init(this)});
$(this).removeAttr("disabled");
}
...
},resize:function(jq,_a2a){
return jq.each(function(){
_9fe(this,_a2a);
});
},getValue:function(jq){
return jq.slider("options").value;
},setValue:function(jq,_a2b){
return jq.each(function(){
_a15(this,_a2b);
});
},clear:function(jq){
...
$.fn.slider.parseOptions=function(_a2c){
var t=$(_a2c);
return $.extend({},$.parser.parseOptions(_a2c,["width","height","mode",{reversed:"boolean",showTip:"boolean",min:"number",max:"number",step:"number"}]),{value:(t.val()||undefined),disabled:(t.attr("disabled")?true:undefined),rule:(t.attr("rule")?eval(t.attr("rule")):undefined)});
};
$.fn.slider.defaults={width:"auto",height:"auto",mode:"h",reversed:false,showTip:false,disabled:false,value:0,min:0,max:100,step:1,rule:[],tipFormatter:function(_a2d){
return _a2d;
},converter:{toPosition:function(_a2e,size){
var opts=$(this).slider("options");
return (_a2e-opts.min)/(opts.max-opts.min)*size;
},toValue:function(pos,size){
var opts=$(this).slider("options");
return opts.min+(opts.max-opts.min)*(pos/size);
}},onChange:function(_a2f,_a30){
},onSlideStart:function(_a31){
},onSlideEnd:function(_a32){
},onComplete:function(_a33){
}};
})(jQuery);
