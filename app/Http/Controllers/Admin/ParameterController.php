...
//    protected $permission;
    ...
    public function __construct(RoleRepositoryEloquent $role, PermissionRepositoryEloquent $permission)
    {
        ...
        Breadcrumbs::register('admin-parameter', function ($breadcrumbs) {
            $breadcrumbs->parent('dashboard');
            $breadcrumbs->push('系统配置', route('admin.parameter.index'));
        });
    }
    ...
    {
//        Breadcrumbs::register('admin-parameter-index', function ($breadcrumbs) {
//            $breadcrumbs->parent('admin-parameter');
//            $breadcrumbs->push('系统配置', route('admin.parameter.index'));
//        });

        $roles = $this->role->paginate(10);
        return view('admin.rbac.parameters.index', compact('roles'));
    }
